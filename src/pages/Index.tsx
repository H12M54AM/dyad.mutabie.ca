        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl hover:bg-bg-secondary transition-all duration-300 border border-border shadow-sm hover:shadow-md">
              ...
              <p className="text-text-secondary">Build applications faster with intelligent code suggestions and automated UI generation.</p>
            </div>
            <div className="p-8 rounded-2xl hover:bg-bg-secondary transition-all duration-300 border border-border shadow-sm hover:shadow-md">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
              ...
              <p className="text-text-secondary">Access a rich collection of pre-built, customizable components for any use case.</p>
            </div>
            <div className="p-8 rounded-2xl hover:bg-bg-secondary transition-all duration-300 border border-border shadow-sm hover:shadow-md">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
              ...
              <p className="text-text-secondary">See your changes instantly with live preview and hot reloading during development.</p>
            </div>
          </div>
        </div>
      </section>
